    ...
    <div class="content-container">
        ...
        <div class="register">
            ...
            <form action="register.php" method="POST">
                <label for="uname"><b id="login_page_text">Username</b></label>
                <br>
                <input class="form_field" id="register_uname" type="text" placeholder="Enter Username" name="uname_reg"
                    required>
                ...
                <br>
                <input class="form_field" id="register_pwd_1" type="password" placeholder="Enter Password"
                    name="pwd_reg_1" required>
                <br>
                <label for="pwd"><b id="login_page_text">Repeat Password</b></label>
                <br>
                <input class="form_field" id="register_pwd_2" type="password" placeholder="Repeat Password"
                    name="pwd_reg_2" required>
                <br>
